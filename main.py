...
def main():
    ...
    if st.session_state.data is None:
        ...
        st.markdown("<h2 class='app-subtitle'>Dashboard Data Analysis Tool</h2>", unsafe_allow_html=True)
        ...
        <div class='upload-section'>
            ...
            <p>Please upload a CSV file with Truenat diagnostic data</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        if uploaded_file:
            try:
                ...
                st.info("Please ensure your CSV file has the correct column structure.")
                return
